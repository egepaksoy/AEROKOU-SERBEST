...
def second_miss(stop_event, vehicle: Vehicle, config, targets, target_locker):
    def second_miss(stop_event, config, model_path, vehicle: Vehicle, DRONE_ID, target_loc, target_cls):
        ...
        saldiri_camera_handler.show_image(f"Drone {DRONE_ID} Kamera")
...
try:
    targets = {2: {"cls": "fire-poster", "loc": [-35.36303873, 149.16521821]}, 3: {"cls": "fire-poster", "loc": [-35.36363873, 149.16511821]}}
    ...
    while second_miss_thrd.is_alive() and not stop_event.is_set():
        time.sleep(2)
